...
def index():
    return render_template('index.html', 
                          ...
                          description="Generate secure, unique identifiers instantly for your applications and databases. Free online UUID generator with v1, v4, v5, v7 and GUID support.",
                          schema_type="WebApplication",
                          canonical_url="https://easyuuidgenerator.com/",
                          keywords="uuid generator, guid generator, uuid v4, uuid v1, uuid v5, uuid v7, online generator, unique id")
...
def generate_bulk():
    ...
    uuids = generate_bulk_uuids(uuid_type, count, namespace=namespace, name=name)
